    ...
    <div className="w-[500px] p-5 rounded-2xl bg-linear-to-br from-black/60 to-black/70 backdrop-blur-md border border-white/20 shadow-xl text-white space-y-4">
      ...
      <div className="flex gap-8">
        <button
          ...
          className="bg-white/20 rounded-full p-2 px-3 cursor-pointer border-2 border-transparent hover:border-white/60"
        >
          🇬🇧
        </button>
        <button
        ...
        <button
          ...
          className="bg-white/20 rounded-full p-2 cursor-pointer border-2 border-transparent hover:border-white/60"
        >
          🇰🇿 🦅
        </button>
      </div>
