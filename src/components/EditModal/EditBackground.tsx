  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="grid grid-cols-2 gap-2">
        <img src="/defaultBg.jpg" alt="" className="rounded-2xl w-70 h-40 hover:border hover:border-white" onClick={handleDefaultChange}/>
        <img src="/darkGreen.jpg" alt="" className="rounded-2xl w-70 h-40 hover:border hover:border-white" onClick={handleDefaultChange}/>
        <img src="/city.jpg" alt="" className="rounded-2xl w-70 h-40 hover:border hover:border-white" onClick={handleDefaultChange}/>
        <img src="/snow.jpg" alt="" className="rounded-2xl w-70 h-40 hover:border hover:border-white" onClick={handleDefaultChange}/>
      </div>
